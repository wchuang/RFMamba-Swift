...
@implementation RFMemoryCache

+ (instancetype)defaultCache
{
    NSAssert([NSThread isMainThread], @"RFMemoryCache is not running on Main Thread!");
    static RFMemoryCache *instance = nil;
